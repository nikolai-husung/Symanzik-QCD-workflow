id vert(field1?{aquark,aquark2}(p?,alpha?,cf1?,fl1?,ti1?),field2?{quark,quark2}(q?,beta?,cf2?,fl2?,ti2?),field3?{gluon,bgf}(r?,gamma?,b?,fl?),anchor(?args)) = 
...
#do dummy=1,1
   ...
   if(match(vert(field1?{aquark,aquark2}(p?,alpha?,cf0?,fl0?),field2?{quark,quark2}(q?,beta?,cf1?,fl1?,ti1?),field3?{gluon,bgf}(r?,gamma?,col0?,fl2?,ti2?),field4?{gluon,bgf}(s?,delta?,col1?,fl3?,ti3?),anchor(?args)))>0) redefine dummy "0";
   .sort;
#enddo
...
#do dummy=1,1
   ...
   if(match(vert(field1?{aquark,aquark2}(p?,alpha?,cf0?,fl0?),field2?{quark,quark2}(q?,beta?,cf1?,fl1?,ti1?),field3?{gluon,bgf}(r?,gamma?,col0?,fl2?,ti2?),field4?{gluon,bgf}(s?,delta?,col1?,fl3?,ti3?),field5?{gluon,bgf}(t?,mu?,col2?,fl4?,ti4?),anchor(?args)))>0) redefine dummy "0";
   .sort;
#enddo
