#do dummy=1,1
   id,once vert(field1?{aquark,aquark2}(p?,alpha?,cf1?,fl1?,ti1?),field2?{quark,quark2}(q?,beta?,cf2?,fl2?,ti2?),anchor(?args)) =
      - DO4v(spt`sptcnt',q,q,q)*i_*d_(cf1,cf2)*FL(fl1,spt`sptcnt',fl2)*Tau(ti1,ti2);
   redefine sptcnt "{`sptcnt'+1}";
   if(match(vert(field1?{aquark,aquark2}(p?,alpha?,cf1?,fl1?,ti1?),field2?{quark,quark2}(q?,beta?,cf2?,fl2?,ti2?),anchor(?args)))>0);
      redefine dummy "0";
   endif;
   .sort;
#enddo
...
#do dummy=1,1
   id,once vert(field1?{aquark,aquark2}(p?,alpha?,cf1?,fl1?,ti1?),field2?{quark,quark2}(q?,beta?,cf2?,fl2?,ti2?),field3?{gluon,bgf}(r?,gamma?,b?,fl3?,ti3?),anchor(?args)) = (
      - 3*TC(b,cf1,cf2)*DO4v(gamma,spt`sptcnt',q,q)
      - 3*TC(b,cf1,cf2)*DO4v(gamma,spt`sptcnt',q,r)
      - TC(b,cf1,cf2)*DO4v(gamma,spt`sptcnt',r,r)
   )*g*FL(fl1,spt`sptcnt',fl2)*Tau(ti1,ti2);

   redefine sptcnt "{`sptcnt'+1}";
   if(match(vert(field1?{aquark,aquark2}(p?,alpha?,b?,fl1?,ti1?),field2?{quark,quark2}(q?,beta?,c?,fl2?,ti2?),field3?{gluon,bgf}(r?,gamma?,d?,fl3?,ti3?),anchor(?args)))>0);
      redefine dummy "0";
   endif;
   .sort;
#enddo
...
#do dummy=1,1
   ...
   )*i_*g^2*FL(fl1,spt`sptcnt',fl2)*Tau(ti1,ti2);

   redefine cfcnt "{`cfcnt'+1}";
   redefine sptcnt "{`sptcnt'+1}";
   if(match(vert(field1?{aquark,aquark2}(p?,alpha?,cf1?,fl1?,ti1?),field2?{quark,quark2}(q?,beta?,cf2?,fl2?,ti2?),field3?{gluon,bgf}(r?,gamma?,b?,fl3?,ti3?),field4?{gluon,bgf}(s?,delta?,c?,fl4?,ti4?),anchor(?args)))>0);
      redefine dummy "0";
   endif;
   .sort;
#enddo
...
#do dummy=1,1
   ...
   )*g^3*FL(fl1,spt`sptcnt',fl2)*DO4v(gamma,delta,mu,spt`sptcnt')*Tau(ti1,ti2);
