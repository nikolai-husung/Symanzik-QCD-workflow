id vert(field?{aquark,aquark2}(p?,alpha?,cf1?,fl1?),field2?{quark,quark2}(q?,beta?,cf2?,fl2?),anchor(?args)) =
   - OPF(field2(fl1))*FL(fl1,fl2)*d_(cf1,cf2)*q.q*M(field2)
   - OPF(field2(fl1))*FL(fl1,q,fl2)*d_(cf1,cf2)*q.q*i_;
...
id vert(field?{aquark,aquark2}(p?,alpha?,cf1?,fl1?),field2?{quark,quark2}(q?,beta?,cf2?,fl2?),field3?{bgf,gluon}(r?,spt3?,b?,fl3?),anchor(?args)) =
   + 2*TC(b,cf1,cf2)*OPF(field2(fl1))*FL(fl1,fl2)*q(spt3)*i_*M(field2)*g
   + TC(b,cf1,cf2)*OPF(field2(fl1))*FL(fl1,fl2)*r(spt3)*i_*M(field2)*g
   - 2*TC(b,cf1,cf2)*OPF(field2(fl1))*FL(fl1,q,fl2)*q(spt3)*g
   - TC(b,cf1,cf2)*OPF(field2(fl1))*FL(fl1,q,fl2)*r(spt3)*g
   - TC(b,cf1,cf2)*OPF(field2(fl1))*FL(fl1,spt3,fl2)*q.q*g
...
#do dummy=1,1
   id,once vert(field?{aquark,aquark2}(p?,alpha?,cf1?,fl1?),field2?{quark,quark2}(q?,beta?,cf2?,fl2?),field3?{bgf,gluon}(r?,spt3?,b?,fl3?),field4?{bgf,gluon}(s?,spt4?,c?,fl4?),anchor(?args)) =
      + TC(b,cf1,cf`cfcnt')*TC(c,cf`cfcnt',cf2)*OPF(field2(fl1))*FL(fl1,fl2)*d_(spt3,spt4)*M(field2)*g^2
      + TC(b,cf`cfcnt',cf2)*TC(c,cf1,cf`cfcnt')*OPF(field2(fl1))*FL(fl1,fl2)*d_(spt3,spt4)*M(field2)*g^2
      + TC(b,cf1,cf`cfcnt')*TC(c,cf`cfcnt',cf2)*OPF(field2(fl1))*FL(fl1,q,fl2)*d_(spt3,spt4)*i_*g^2
      + TC(b,cf`cfcnt',cf2)*TC(c,cf1,cf`cfcnt')*OPF(field2(fl1))*FL(fl1,q,fl2)*d_(spt3,spt4)*i_*g^2
...
#do dummy=1,1
   ...
   if(match(vert(field?{aquark,aquark2}(?args1),field2?{quark,quark2}(?args2),field3?{bgf,gluon}(?args3),field4?{bgf,gluon}(?args4),field5?{bgf,gluon}(t?,spt5?,d?,fl5?),anchor(?args)))>0) redefine dummy "0";
   .sort;
#enddo
